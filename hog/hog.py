...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while i <= num_rolls:
        ...
        if num == 1:
            ...
            sum += num
        i += 1
    return sum if flag == 0 else flag
    # END PROBLEM 1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    num_of_dice = 0
    for i in range(1, 11):
        averaged_score = averaged_roll_dice(i, dice)
        if averaged_score > highest_average_score:
            num_of_dice = i
            highest_average_score = averaged_score
    return num_of_dice
    # END PROBLEM 9
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    return 0 if bacon_points >= cutoff else num_rolls  # Replace this statement
    # END PROBLEM 10
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    extra_points = free_bacon(opponent_score)
    if extra_turn(score + extra_points, opponent_score):
        num_rolls = 0
    else:
        num_rolls = bacon_strategy(score, opponent_score,cutoff, num_rolls)
